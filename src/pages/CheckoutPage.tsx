                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className={`flex-1 min-w-0 rounded-lg border-2 bg-white px-4 py-3 text-gray-900 outline-none transition-all placeholder:text-gray-400 focus:border-[#d4af37] ${
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-12 md:grid-cols-[2fr_1fr_1fr_1fr]">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="https://x.com/arkidhq" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-base text-white hover:text-[#d4af37]">
                ...
                <li>
                  <a href="https://www.instagram.com/arkid.hq" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-base text-white hover:text-[#d4af37]">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
